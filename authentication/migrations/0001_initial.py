# Generated by Django 3.0 on 2019-12-10 04:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Cuando fue creada la entrada.')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Cuando fue actualizada la entrada por ultima vez.')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role', to='authentication.Role')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_user', to='authentication.User')),
            ],
            options={
                'abstract': False,
            },
